...
def update_flat_chart(df: pd.DataFrame):
    ...
    return {'data': [go.Scatter(
        ...
        'layout': go.Layout(
            xaxis=dict(title="axis 1", showgrid=False, visible=False),
            yaxis=dict(title="axis 2", showgrid=False, visible=False),
            width=800,
            height=800,
...
def update_class_selector(classes: dict[str, list]):
    ...
    figure = dict(
        ...
        layout=go.Layout(title="Selector button: click on sections to hide/show reagent roles",
